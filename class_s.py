...
class NcpApi():
    ...
    def add_access_group_rule_inbound_from_excel(self, inboundfile):
        ...
        body = {
            ...
            # 실제 API 호출을 여기서 수행하도록 작성
            # 예를 들어, self.add_access_group_rule_inbound(access_control_group_no, protocol_type, ip_block, port_range, access_control_group_rule_type, access_control_group_rule_description)
